# DataAssetManager.NorthAsia.HUA
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9b243e39-7a87-42ef-8e53-c22a2938007d
```

> `9b243e39-7a87-42ef-8e53-c22a2938007d` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `DataAssetManager.NorthAsia.HUA` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
