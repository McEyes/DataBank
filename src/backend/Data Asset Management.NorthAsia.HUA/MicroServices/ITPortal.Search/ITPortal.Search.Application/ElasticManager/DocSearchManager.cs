...
{
    public class DocSearchManager : LightElasticsearchService
    {
        ...
        private readonly ILogger<DocSearchManager> _logger;


        public DocSearchManager(
            ...
            ILogger<DocSearchManager> logger
            ...
            int pageSize = 10)
        {
            ...
            var result = await Client.SearchAsync<TopicDocumentModel>(p =>
            ...
            GroupByTopicDocumentQueryModel query, string userId)
        {
            ...
            documents.PageSize = documents.Total = documents.Data.Count;
            documents.PageNum = 1;
            return documents;
        }
        ...
        {
            DeleteByQueryResponse res = await DeleteManyAsync<TopicDocumentModel>(ids);
            return res != null && res.IsValid;
        }
        ...
        private async Task<(long totalCount, List<string> topics)> GetTopicByUserId(string userId, int pageIndex = -1, int pageSize = -1)
        {
            ...
            List<Guid> roleIds = new List<Guid>();// await _userRolesService.GetRolesByUserId(userId.Value);
