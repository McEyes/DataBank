...
namespace ITPortal.Core.ProxyApi.Flow.Dto
{
    ...
    {
        /// <summary>
        /// 流程模板id，和流程模板名称二选一，建议使用流程模板名称，后续流程模板会有版本控制，流程模板id也就不是固定的了
        /// </summary>
        public string FlowTempId { get; set; }
        /// <summary>
        /// 流程模板名称，和流程id名称二选一，建议使用流程模板名称
        /// </summary>
        public string FlowTempName { get; set; }
        /// <summary>
        /// 流程表单id，有传入是，流程id=formid，没传入时，会new一个
        /// </summary>
        ...
        /// <summary>
        /// 流程表单数据，邮件模板或者待办url会用到的参数，也可以直接保存业务数据，这样可以不用创建业务表
        /// </summary>
    ...
    public class FlowAttachmentInfo : AuditEntity<Guid>
    {
    ...
    {
        /// <summary>
        /// 待办id，待办id和流程id二选一，必须要有一个
        /// </summary>
        public Guid? Id { get; set; }
        /// <summary>
        /// 流程id，待办id和流程id二选一，必须要有一个
        /// </summary>
    ...
    public class FlowInstEntity : Entity<Guid>
    {
