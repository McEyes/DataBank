...
{
    public interface IElasticSearchService<TEntity, KeyType> where TEntity : class, IEntity<KeyType>
    {
        /// <summary>
        /// 自动生成，根据属性配置，可以修改
        /// </summary>
    ...
    public interface IElasticSearchService<T> where T : class, IEntity<string>
    {
