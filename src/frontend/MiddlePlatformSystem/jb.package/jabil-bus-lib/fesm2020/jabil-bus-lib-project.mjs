...
LoadingComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: LoadingComponent, selectors: [["jabil-loading"]], decls: 2, vars: 0, consts: [[1, "pi", "pi-spin", "pi-spinner", 2, "font-size", "2rem"]], template: function LoadingComponent_Template(rf, ctx) { if (rf & 1) {
...
VideoDialogModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [CommonModule,
        DialogModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(VideoDialogModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(VideoDialogModule, { declarations: [VideoDialogComponent], imports: [CommonModule,
...
function LayoutComponent_div_1_img_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "img", 15);
} if (rf & 2) {
    const ctx_r6 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("src", ctx_r6.layoutLogo, i0.ɵɵsanitizeUrl);
} }
function LayoutComponent_div_1_img_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "img", 15);
} if (rf & 2) {
...
function LayoutComponent_div_1_p_panelMenu_4_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_div_1_p_tieredMenu_5_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_div_4_span_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, ">>");
    i0.ɵɵelementEnd();
} }
function LayoutComponent_div_4_span_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, ">>");
    i0.ɵɵelementEnd();
} }
function LayoutComponent_div_4_img_11_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_div_4_img_12_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_div_4_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_ng_container_8_li_3_a_1_a_1_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_ng_container_8_li_3_a_1_i_3_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_ng_container_8_li_3_a_1_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_ng_container_8_li_3_Template(rf, ctx) { if (rf & 1) {
...
function LayoutComponent_ng_container_8_p_contextMenu_4_Template(rf, ctx) { if (rf & 1) {
...
class LayoutComponent {
    ...
    async ngOnInit() {
        ...
        this.menuList = await this.appMenuService.getMenuData(this.menuTreeKeys, this.menuTree);
        ...
        if (!this.canGetData) {
            const path = this.location.path();
            // @ts-ignore
            this.fullPage = this.route.snapshot?.children[0]?.firstChild?.data?.fullScreen || false;
            if (path.includes('jabil-bus-screen')) {
                this.fullPage = true;
            }
        }
    ...
    buildSelectedIndex() {
        ...
        this.tabMenu.forEach((item, i) => {
            if (item?.routerLink === location || '/' + item?.routerLink === location) {
                hasTab = true;
    ...
    setTab() {
        if (this?.menuList[0]?.items && this?.menuList[0]?.items[0]?.items) {
    ...
    logoff() {
        ...
        iframe?.length > 0 && iframe[0]?.contentWindow?.location?.reload();
        const removeItems = [
            'loginCheck',
            'loginType',
            'selectedIndex',
    ...
    broadcastIframeUpdate() {
        ...
        // @ts-ignore
        if (item?.isWebApp && window?.router) {
            if (this.location.path().includes('/jabil-bus-screen')) {
                // @ts-ignore
                window?.router?.navigate([item.routerLink]);
                return;
            }
            let url = '';
            if (this.firstJoin) {
            ...
            // @ts-ignore
            window?.router?.navigate([url]).then(() => {
    ...
    initTabScroll() {
        setTimeout(() => {
            ...
            myTab?.scrollTo(1, 0);
            // @ts-ignore
            this.hasScroll = myTab?.scrollLeft > 0;
            myTab?.scrollTo(0, 0);
        }, 500);
    }
    scroll(type) {
        ...
        // @ts-ignore
        const step = type === 'left' ? element?.scrollLeft - 500 : element?.scrollLeft + 500;
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(LayoutModule, { declarations: [LayoutComponent], imports: [CommonModule,
        PanelMenuModule,
        ToastModule,
        TieredMenuModule,
        CheckboxModule,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DefaultRouteGuardService, [{
        type: Injectable
    }], function () { return [{ type: i2$2.Router }, { type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, null); })();
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FormatTimeModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SecondToHourModule, [{
        type: NgModule,
        args: [{
