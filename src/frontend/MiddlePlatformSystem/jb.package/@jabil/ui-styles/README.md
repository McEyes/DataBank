...
1. `cd` into a consumer project directory, then run `npm link @jabil/ui-styles`
...
[badge/media/build-status]: https://dev.azure.com/jblinnersource/UIUX%20Community/_apis/build/status/ui-styles?branchName=main
[badge/build-status]: https://dev.azure.com/jblinnersource/UIUX%20Community/_build/latest?definitionId=3&branchName=main
